...
type EgldBlock struct {
	...
	NumTxs float64 `json:"numTxs,omitempty"`
	// Array of shard blocks
	ShardBlocks []EgldShardBlock `json:"shardBlocks,omitempty"`
	// Array of transactions.
	Transactions []EgldTx `json:"transactions,omitempty"`
}
