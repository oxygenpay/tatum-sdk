...
type EgldTx struct {
	...
	// Source shard.
	SourceShard float64 `json:"sourceShard,omitempty"`
	// Destination shard.
	DestinationShard float64 `json:"destinationShard,omitempty"`
	// Nonce of block which contains current transaction.
	BlockNonce float64 `json:"blockNonce,omitempty"`
	...
	HyperblockNonce float64 `json:"hyperblockNonce,omitempty"`
