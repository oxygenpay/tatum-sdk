...
type CeloApiService service
/*
CeloApiService Invoke a method in a smart contract on Celo
...
*/
func (a *CeloApiService) CeloBlockchainSmartContractInvocation(ctx context.Context, body CeloSmartcontractBody) (InlineResponse20020, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v3/celo/smartcontract"
...
/*
CeloApiService Send Celo / ERC20 from account to account
...
*/
func (a *CeloApiService) CeloBlockchainTransfer(ctx context.Context, body CeloTransactionBody) (InlineResponse2005, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/celo/transaction"
...
/*
CeloApiService Broadcast signed Celo transaction
&lt;p&gt;&lt;b&gt;2 credits per API call&lt;/b&gt;&lt;/p&gt; &lt;p&gt;Broadcast signed transaction to Celo blockchain. This method is used internally from Tatum KMS or Tatum client libraries. It is possible to create custom signing mechanism and use this method only for broadcasting data to the blockchian.&lt;/p&gt; 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
@return TransactionHash
*/
func (a *CeloApiService) CeloBroadcast(ctx context.Context, body BroadcastKms) (TransactionHash, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/celo/broadcast"
...
/*
CeloApiService Generate Celo account address from Extended public key
...
*/
func (a *CeloApiService) CeloGenerateAddress(ctx context.Context, xpub string, index float64) (InlineResponse20055, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/celo/address/{xpub}/{index}"
...
/*
CeloApiService Generate Celo private key
...
@return PrivKey
*/
func (a *CeloApiService) CeloGenerateAddressPrivateKey(ctx context.Context, body PrivKeyRequest) (PrivKey, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/celo/wallet/priv"
...
/*
CeloApiService Generate Celo wallet
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CeloApiCeloGenerateWalletOpts - Optional Parameters:
     * @param "Mnemonic" (optional.String) -  Mnemonic to use for generation of extended public and private keys.
@return Wallet
*/

type CeloApiCeloGenerateWalletOpts struct {
    Mnemonic optional.String
}

func (a *CeloApiService) CeloGenerateWallet(ctx context.Context, localVarOptionals *CeloApiCeloGenerateWalletOpts) (Wallet, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/celo/wallet"
...
/*
CeloApiService Get Celo Account balance
...
*/
func (a *CeloApiService) CeloGetBalance(ctx context.Context, address string) (InlineResponse20056, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/celo/account/balance/{address}"
...
/*
CeloApiService Get Celo block by hash
&lt;p&gt;&lt;b&gt;1 credit per API call&lt;/b&gt;&lt;/p&gt; &lt;p&gt;Get Celo block by block hash or block number.&lt;/p&gt; 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param hash Block hash or block number
@return CeloBlock
*/
func (a *CeloApiService) CeloGetBlock(ctx context.Context, hash string) (CeloBlock, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CeloBlock
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/celo/block/{hash}"
...
/*
CeloApiService Get current block number
&lt;p&gt;&lt;b&gt;1 credit per API call&lt;/b&gt;&lt;/p&gt; &lt;p&gt;Get Celo current block number. This is the number of the latest block in the blockchain.&lt;/p&gt; 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return float64
*/
func (a *CeloApiService) CeloGetCurrentBlock(ctx context.Context) (float64, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/celo/block/current"
...
/*
CeloApiService Get Celo Transaction
&lt;p&gt;&lt;b&gt;2 credits per API call&lt;/b&gt;&lt;/p&gt; &lt;p&gt;Get Celo transaction by transaction hash.&lt;/p&gt; 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param hash Transaction hash
@return CeloTx
*/
func (a *CeloApiService) CeloGetTransaction(ctx context.Context, hash string) (CeloTx, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CeloTx
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/celo/transaction/{hash}"
	localVarPath = strings.Replace(localVarPath, "{"+"hash"+"}", fmt.Sprintf("%v", hash), -1)
...
/*
CeloApiService Get Celo transactions by address
 ...
 * @param optional nil or *CeloApiCeloGetTransactionByAddressOpts - Optional Parameters:
...
type CeloApiCeloGetTransactionByAddressOpts struct {
...
func (a *CeloApiService) CeloGetTransactionByAddress(ctx context.Context, address string, pageSize float64, localVarOptionals *CeloApiCeloGetTransactionByAddressOpts) ([]CeloTx, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/celo/account/transaction/{address}"
	localVarPath = strings.Replace(localVarPath, "{"+"address"+"}", fmt.Sprintf("%v", address), -1)
...
/*
CeloApiService Get count of outgoing Celo transactions
...
@return float64
*/
func (a *CeloApiService) CeloGetTransactionCount(ctx context.Context, address string) (float64, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/celo/transaction/count/{address}"
	localVarPath = strings.Replace(localVarPath, "{"+"address"+"}", fmt.Sprintf("%v", address), -1)
